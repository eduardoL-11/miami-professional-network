/* Miami Professional Network — Outline icon system
   Lucide-inspired SVG icons, monochrome, stroke 2.
   Usage: <i class="i" data-icon="search"></i>
   Sizes: add class i-sm (14px) / i-lg (20px) / i-xl (28px) / i-2xl (40px), or override with font-size.
*/
(function () {
  ...
  const ICONS = {
    ...
    'sparkles':        '<path d="m12 3-1.45 4.4L6 8.85l4.55 1.45L12 14.7l1.45-4.4L18 8.85l-4.55-1.45z"/><path d="M5 21v-4"/><path d="M3 19h4"/><path d="M19 18v-2"/><path d="M18 17h2"/>',
    ...
    'graduation-cap':  '<path d="M22 10v6"/><path d="M2 10l10-5 10 5-10 5z"/><path d="M6 12v5a4 4 0 0 0 4 2h4a4 4 0 0 0 4-2v-5"/>',
    ...
    'star-filled':     '<polygon fill="currentColor" stroke="currentColor" points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"/>',
    'bookmark':        '<path d="m19 21-7-4-7 4V5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2z"/>',
    'bookmark-filled': '<path fill="currentColor" stroke="currentColor" d="m19 21-7-4-7 4V5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2z"/>',
    ...
    'wave':            '<path d="M2 12c2-2 4 2 6 0s4-4 6-2 4 2 6 0"/>',
  ...
  function render(root) {
    ...
    scope.querySelectorAll('i[data-icon], span[data-icon].i').forEach((el) => {
  ...
  window.MPNIcons = { render, svgFor, ICONS };
})();
